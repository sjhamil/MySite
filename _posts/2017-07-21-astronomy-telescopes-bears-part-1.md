...
After pretty smooth travels (aside from a two hour delay in Minneapolis) I
...
In the evening, we had the chance to head over to one of telescopes we'd be
...
<img src="{{ '/img/KPNO17/sunset_pano.jpg' | prepend: site.baseurl }}"
alt="Sunset at MDM" title="Sunset at MDM">
...
It was after 2am by the time we had ironed out any kinks in the procedures and
...
<center><img src="{{ '/img/KPNO17/pano_mcgrath_elderbrother.jpg' | prepend:
site.baseurl }}" title="The view looking south from the Kitt Peak summit."
alt="The view looking south from the Kitt Peak summit."></center>
